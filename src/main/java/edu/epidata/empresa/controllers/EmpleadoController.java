...
public class EmpleadoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Empleado> getEmpleado(@PathVariable(value="id")Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Empleado> updateEmpleado(@PathVariable(value="id")Long id, @RequestBody Empleado empleado) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Empleado> deleteEmpleado(@PathVariable(value="id")Long id) {
        try {
